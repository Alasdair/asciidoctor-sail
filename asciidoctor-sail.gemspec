...
Gem::Specification.new do |s|
  ...
  s.description = 'Asciidoctor extension for documenting Sail models'
  s.summary = 'An Asciidoctor extension that supports including formatted Sail source in ISA manuals'
