...
contents of a Sail source file. Second, there is an asciidoctor
plugin, which uses these bundles to include Sail source code in
asciidoc manuals without duplicating the code, which would invariably
lead to it getting out of sync over time.
